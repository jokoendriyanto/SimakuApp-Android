package com.smkmutuharjo.jurnalmu;
...
import static com.smkmutuharjo.jurnalmu.Functions.aswm_fcm_id;
import static com.smkmutuharjo.jurnalmu.Functions.aswm_host;
...
public class SmartWebView {
	...
	static boolean ASWP_COPYPASTE     = true;        // enable copy/paste within webview
	...
	// URL configs
	static String ASWV_URL_ONLINE	  = "https://simaku.smkmuh1-skh.sch.id/login";	// if online URL is not provided, offline URL will be loaded by default
	...
	static String USER_AGENT_POSTFIX        = "SimakuApps"; // useful for identifying traffic, e.g. in Google Analytics
